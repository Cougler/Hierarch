...
export const STARTER_PROJECTS: Project[] = [
  {
    ...
    description: 'A quick tour of Hierarch. Each task below shows a different phase. Try dragging them across the board.',
    metadata: {
      icon: 'Compass',
      color: '#8b5cf6',
      order: 0,
...
export const STARTER_TASKS: Task[] = [
  {
    id: 'st-explore',
    title: 'Explore: early research goes here',
    description: 'The first phase. Use it for brainstorming, research, and open-ended discovery.',
    status: 'explore',
    tags: [],
  ...
  {
    id: 'st-define',
    title: 'Define: lock in your approach',
    description: 'Scope is set, requirements are clear. Drag to Refine when you start producing final work.',
    status: 'define',
    tags: [],
    ...
    phaseHistory: [
      { id: 'st-ph-1', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-1) },
    ],
  },
  {
    id: 'st-refine',
    title: 'Refine: produce the final work',
    description: 'High-fidelity output happens here. Move to Feedback when you need a review.',
    status: 'refine',
    tags: [],
    ...
    createdAt: daysFromNow(-3),
    phaseHistory: [
      { id: 'st-ph-2', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-2) },
      { id: 'st-ph-3', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-1) },
    ],
  },
  {
    id: 'st-feedback',
    title: 'Feedback: waiting for a review',
    description: 'Moving a task here auto-creates a feedback note. Record the response in one place.',
    status: 'feedback',
    tags: [],
    ...
    createdAt: daysFromNow(-3),
    phaseHistory: [
      { id: 'st-ph-4', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-3) },
      { id: 'st-ph-5', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-2) },
      { id: 'st-ph-6', fromPhase: 'refine', toPhase: 'feedback', timestamp: daysFromNow(-1), reviewer: 'Design Lead' },
    ],
  },
  {
    id: 'st-handoff',
    title: 'Handoff: done and delivered',
    description: 'Completed work lands here. These tasks are hidden from active counts.',
    status: 'handoff',
    tags: [],
    dueDate: daysFromNow(-2),
    assignees: [],
    ...
    createdAt: daysFromNow(-3),
    phaseHistory: [
      { id: 'st-ph-7', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-3) },
      { id: 'st-ph-8', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-2) },
      { id: 'st-ph-9', fromPhase: 'refine', toPhase: 'handoff', timestamp: daysFromNow(-1) },
    ],
  },
]
...
export const STARTER_DESIGN_NOTES: Artifact[] = [
  ...
  {
    id: 'st-note-feedback',
    title: 'Feedback: Feedback: waiting for a review',
...
export const DEMO_TASKS: Task[] = [
...

  {
    ...
    phaseHistory: [
      { id: 'ph-fn1a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-25) },
      { id: 'ph-fn1b', fromPhase: 'define', toPhase: 'handoff', timestamp: daysFromNow(-22) },
    ],
  },
  {
    id: 'task-fn-2',
    ...
    phaseHistory: [
      { id: 'ph-fn2a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-18) },
      { id: 'ph-fn2b', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-15) },
      { id: 'ph-fn2c', fromPhase: 'refine', toPhase: 'feedback', timestamp: daysFromNow(-13), reviewer: 'Sarah Chen' },
      { id: 'ph-fn2d', fromPhase: 'feedback', toPhase: 'handoff', timestamp: daysFromNow(-12) },
    ],
  },
  {
    id: 'task-fn-3',
    ...
    phaseHistory: [
      { id: 'ph-fn3a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-8) },
      { id: 'ph-fn3b', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-5) },
      { id: 'ph-fn3c', fromPhase: 'refine', toPhase: 'feedback', timestamp: daysFromNow(-1), reviewer: 'Marcus Webb', notes: 'Reviewing balance card hierarchy and transaction grouping' },
    ],
  },
  {
    id: 'task-fn-4',
    ...
    phaseHistory: [
      { id: 'ph-fn4a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-5) },
      { id: 'ph-fn4b', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-2) },
    ],
  },
  {
    id: 'task-fn-5',
    ...
    createdAt: daysFromNow(-3),
    phaseHistory: [
      { id: 'ph-fn5a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-1) },
    ],
  },
  {
    id: 'task-fn-6',
...

  {
    ...
    phaseHistory: [
      { id: 'ph-lm1a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-18) },
      { id: 'ph-lm1b', fromPhase: 'define', toPhase: 'handoff', timestamp: daysFromNow(-14) },
    ],
  },
  {
    id: 'task-lm-2',
    ...
    phaseHistory: [
      { id: 'ph-lm2a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-10) },
      { id: 'ph-lm2b', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-4) },
    ],
    waitingFor: [
      { id: 'wf-lm1', title: 'Insurance API documentation from engineering', completed: true },
      { id: 'wf-lm2', title: 'Provider photo assets from marketing', completed: false },
    ],
  },
  {
    id: 'task-lm-3',
    ...
    phaseHistory: [
      { id: 'ph-lm3a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-2) },
    ],
  },
  {
    id: 'task-lm-4',
...

  {
    ...
    createdAt: daysFromNow(-12),
    phaseHistory: [
      { id: 'ph-wm1a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-10) },
      { id: 'ph-wm1b', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-6) },
      { id: 'ph-wm1c', fromPhase: 'refine', toPhase: 'feedback', timestamp: daysFromNow(-2), reviewer: 'Engineering Lead', notes: 'Reviewing token naming conventions against existing codebase' },
    ],
  },
  {
    id: 'task-wm-2',
    ...
    phaseHistory: [
      { id: 'ph-wm2a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-6) },
      { id: 'ph-wm2b', fromPhase: 'define', toPhase: 'refine', timestamp: daysFromNow(-3) },
    ],
  },
  {
    id: 'task-wm-3',
    ...
    phaseHistory: [
      { id: 'ph-wm3a', fromPhase: 'explore', toPhase: 'define', timestamp: daysFromNow(-2) },
    ],
  },
  {
    id: 'task-wm-4',
