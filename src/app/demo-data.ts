...
export const STARTER_TASKS: Task[] = [
  ...
  {
    id: 'st-design',
    title: 'Design: lock in your approach',
    description: 'Scope is set, requirements are clear. Drag to Iterate when you start producing final work.',
    status: 'design',
    tags: [],
    ...
    phaseHistory: [
      { id: 'st-ph-1', fromPhase: 'explore', toPhase: 'design', timestamp: daysFromNow(-1) },
    ],
  },
  {
    id: 'st-iterate',
    title: 'Iterate: produce the final work',
    description: 'High-fidelity output happens here. Move to Review when you need someone to look at it.',
    status: 'iterate',
    tags: [],
    ...
    createdAt: daysFromNow(-3),
    phaseHistory: [
      { id: 'st-ph-2', fromPhase: 'explore', toPhase: 'design', timestamp: daysFromNow(-2) },
      { id: 'st-ph-3', fromPhase: 'design', toPhase: 'iterate', timestamp: daysFromNow(-1) },
    ],
  },
  {
    id: 'st-review',
    title: 'Review: waiting for a review',
    ...
    createdAt: daysFromNow(-3),
    phaseHistory: [
      { id: 'st-ph-4', fromPhase: 'explore', toPhase: 'design', timestamp: daysFromNow(-3) },
      { id: 'st-ph-5', fromPhase: 'design', toPhase: 'iterate', timestamp: daysFromNow(-2) },
      { id: 'st-ph-6', fromPhase: 'iterate', toPhase: 'review', timestamp: daysFromNow(-1), reviewer: 'Design Lead' },
    ],
  },
  {
    id: 'st-handoff',
    ...
    createdAt: daysFromNow(-3),
    phaseHistory: [
      { id: 'st-ph-7', fromPhase: 'explore', toPhase: 'design', timestamp: daysFromNow(-3) },
      { id: 'st-ph-8', fromPhase: 'design', toPhase: 'iterate', timestamp: daysFromNow(-2) },
      { id: 'st-ph-9', fromPhase: 'iterate', toPhase: 'handoff', timestamp: daysFromNow(-1) },
    ],
  },
]
...
export const STARTER_DESIGN_NOTES: Artifact[] = [
  ...
  },
  {
    id: 'st-note-feedback',
    title: 'Review: waiting for a review',
    text: 'This note was auto-created when the task entered Review. Record reviewer comments here.',
    type: 'feedback',
    projectId: 'proj-starter',
    taskId: 'st-feedback',
...
export const DEMO_DESIGN_NOTES: Artifact[] = [
  ...
  {
    id: 'note-fn-feedback',
    title: 'Review: Account dashboard hi-fi',
  ...
  {
    id: 'note-wm-feedback',
    title: 'Review: Color and typography tokens',
