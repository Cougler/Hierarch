  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: 'pointer-events-auto h-7 w-7 flex items-center justify-center rounded-md text-muted-foreground hover:bg-white/[0.08] hover:text-foreground transition-colors',
        button_next: 'pointer-events-auto h-7 w-7 flex items-center justify-center rounded-md text-muted-foreground hover:bg-white/[0.08] hover:text-foreground transition-colors',
        ...
        day_button: cn(
          ...
          'data-[today]:bg-white/[0.06] data-[today]:font-semibold',
